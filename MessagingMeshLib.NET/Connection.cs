...
namespace MessagingMeshLib.NET
{
    ...
    public class Connection : ClientSocket.ICallback
    {
        ...
        public int sendMessage(Message message, string subject, string replySubject = "")
        {
            ...
            return sendNetworkMessage(networkMessage);
        }
        ...
        {
            // We find the approximate size of the buffer required and create it (with abit of margin
            // to try to avoid further allocation)...
            var size = (int)((networkMessage.Size + sizeof(int)) * 1.1);  // sizeof(int) for the serialization of the buffer size itself
            ...
            // We return the size of the data sent...
