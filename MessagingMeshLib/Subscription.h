...
namespace MessagingMesh
{
    ...
    public:
        ...
        static SubscriptionPtr create(ConnectionImpl* pConnection, const std::string& subject, const CallbackInfo* pCallbackInfo) 
        { 
            return SubscriptionPtr(new Subscription(pConnection, subject, pCallbackInfo));
        }
    ...
    private:
        ...
        Subscription(ConnectionImpl* pConnection, const std::string& subject, const CallbackInfo* callbackInfo);
